  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: SingleChildScrollView(
        //ทำให้เลื่อนได้เวลาเปิดแป้นพิมพ์
        child: Container(
          ...
          child: Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                      padding: const EdgeInsets.fromLTRB(160, 3, 0, 0),
                      child: FlatButton(
                        child: Text(
                          "ยังไม่เป็นสมาชิก",
                          style: TextStyle(
                        ...
                        onPressed: (){
                          print("can register");
                          MaterialPageRoute materialPageRoute = MaterialPageRoute(builder: (BuildContext context) => RegisterPage());
                      ...
                      //     child: Text('aaaa'), onPressed: RegisterPage(),
                      // ),
                      )
                ],
              )),
